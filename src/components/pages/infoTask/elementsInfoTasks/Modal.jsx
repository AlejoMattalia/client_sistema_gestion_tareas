...
import DateForm from "../../home/elementHome/elementsModal/Date";
...
export default function BasicModal({ openModal, setOpenModal, task }) {
  ...
  const { handleSubmit, handleChange, values, errors } = useFormik({
    ...
    onSubmit: (data) => {
      ...
      console.log(values)
      axios.patch(`http://localhost:3000/tasks/${task.id}`, values)
        
        .then((res)=>{
          console.log("Tarea editada correctamente", res);
